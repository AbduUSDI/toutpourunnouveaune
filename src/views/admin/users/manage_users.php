...
<div class="container mt-5">
    ...
    <div class="table-responsive">
        <a href="https://www.abduusdi.fr/toutpourunnouveaune/admin/users/add" class="btn btn-info mb-4">Ajouter un utilisateur</a>
            ...
            <tbody>
                <?php foreach ($users as $user): ?>
                    <tr>
                        ...
                        <td>
                            <a href="https://www.abduusdi.fr/toutpourunnouveaune/admin/users/edit/<?php echo htmlspecialchars($user['id']); ?>" class="btn btn-warning btn-sm">Modifier</a>
                            <form action="https://www.abduusdi.fr/toutpourunnouveaune/admin/users/delete" method="POST" style="display:inline;" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer cet utilisateur ?');">
