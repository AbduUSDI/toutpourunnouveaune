...
<div class="container mt-5">
    ...
    <a href="https://www.abduusdi.fr/toutpourunnouveaune/admin/quiz/add" class="btn btn-info">Ajouter un nouveau quiz</a>
            ...
            <tbody>
                <?php foreach ($quizzes as $quiz): ?>
                    <tr>
                        ...
                        <td>
                            <a href="https://www.abduusdi.fr/toutpourunnouveaune/admin/quiz/update/<?php echo htmlspecialchars($quiz['id']); ?>" class="btn btn-warning">Modifier</a>
                            <form action="https://www.abduusdi.fr/toutpourunnouveaune/admin/quiz/delete" method="POST" style="display:inline;">
