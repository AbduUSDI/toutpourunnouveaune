...
if (!isset($_SESSION['user'])) {
    header('Location: /Portfolio/toutpourunnouveaune/forum/login');
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!isset($_POST['csrf_token']) || $_POST['csrf_token'] !== $_SESSION['csrf_token']) {
        ...
        header('Location: /Portfolio/toutpourunnouveaune/forum/profile');
        exit;
    }
...
<div class="container mt-5">
    <form action="/Portfolio/toutpourunnouveaune/forum/profile" method="POST">
        ...
        <ul class="list-group">
            <?php foreach ($friends as $friend): ?>
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    ...
                    <form action="/Portfolio/toutpourunnouveaune/forum/profile" method="POST" class="d-inline" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer cet ami ?');">
        ...
        <ul class="list-group">
            <?php foreach ($friendRequests as $request): ?>
                <li class="list-group-item">
                    ...
                    <form action="/Portfolio/toutpourunnouveaune/forum/profile" method="POST" class="d-inline">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/Portfolio/toutpourunnouveaune/forum/profile" method="POST" enctype="multipart/form-data">
