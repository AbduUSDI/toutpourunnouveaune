...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!isset($_POST['csrf_token']) || $_POST['csrf_token'] !== $_SESSION['csrf_token']) {
        ...
        header('Location: https://www.abduusdi.fr/toutpourunnouveaune/parent/profile');
        exit;
    }
...
<div class="container mt-5">
    <form action="https://www.abduusdi.fr/toutpourunnouveaune/parent/profile" method="POST">
        ...
        <ul class="list-group">
            <?php foreach ($friends as $friend): ?>
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    ...
                    <form action="https://www.abduusdi.fr/toutpourunnouveaune/parent/profile" method="POST" class="d-inline" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer cet ami ?');">
        ...
        <ul class="list-group">
            <?php foreach ($friendRequests as $request): ?>
                <li class="list-group-item">
                    ...
                    <form action="https://www.abduusdi.fr/toutpourunnouveaune/parent/profile" method="POST" class="d-inline">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="https://www.abduusdi.fr/toutpourunnouveaune/parent/profile" method="POST" enctype="multipart/form-data">
