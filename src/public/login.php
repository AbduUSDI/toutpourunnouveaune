...
body {
    background-image: url('https://www.abduusdi.fr/toutpourunnouveaune/assets/image/background.jpg');
    padding-top: 48px;
}
h1, .mt-5 {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('forgotPasswordForm').addEventListener('submit', function(e) {
        ...
        fetch('https://www.abduusdi.fr/toutpourunnouveaune/forgot_password', {
            method: 'POST',
            body: formData
        })
